...
def donate_text() -> str:
    lines = [
        ...
        "· стабильная работа без рекламы;",
        "· развитие: два корпуса, архив, избранное, поиск.",
        "",
        "<b>Важно</b>",
        "Поддержка <b>добровольная</b>. Бот остаётся бесплатным для всех — "
        "от суммы ничего в расписании не зависит. "
        "Это не оплата услуг техникума и не официальный сервис СПТ.",
        "",
        "<b>Как поддержать</b>",
        "Через <b>CloudTips</b> — карта, СБП и другие способы в форме оплаты.",
    ]
    if config.DONATION_URL:
        lines.append(
            "Нажмите «Оплатить» — откроется страница CloudTips. "
            "Или «QR-код», если удобнее оплатить камерой телефона."
        )
    lines.extend(
        [
            "",
